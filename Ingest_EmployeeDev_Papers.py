...
from employeedev_paper_metadata import PAPER_METADATA
...
PDF_FOLDER = PROJECT_ROOT / "KnowledgeBase" / "EmployeeDevelopment_Papers"
OUTPUT_FOLDER = PROJECT_ROOT / "JsonChunksPapers"
OUTPUT_FILE = OUTPUT_FOLDER / "employeedev_kb.json"
...
def ingest_employeedev_papers() -> None:
    """
    Load all PDFs from KnowledgeBase/EmployeeDevelopment_Papers,
    split them into chunks, attach metadata, and write
    a single JSON file at JsonChunksPapers/employeedev_kb.json.
    """
    ...
    for pdf_path in pdf_files:
        ...
        for doc in split_docs:
            ...
            chunk_id = f"employeedev_{paper_id}_{paper_chunk_index:03d}"
